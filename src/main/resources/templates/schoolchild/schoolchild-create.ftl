...
<div style="width: 25%; margin: 0 auto">
    ...
    <form name="schoolchildForm" action="" method="POST" class="row g-3">
        ...
        <div class="form-group">
            ...
            <input type="number" name="grade" id="grade" class="form-control" placeholder="77" min="0" required>
        </div>

        <div class="form-group">
            <label for="age" class="form-label">Age: </label>
            <input type="number" name="age" id="age" class="form-control" placeholder="9" min="0" required>
        </div>
