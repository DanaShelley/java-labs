    ...
    <form name="editionForm" action="" method="POST" class="row g-3">
        ...
        <div class="form-group">
            ...
            <input type="number" name="numberOfPages" id="numberOfPages" class="form-control" placeholder="320" required
                   min="0" value="${editionForm.numberOfPages}">
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="stockNumber" id="stockNumber" class="form-control" placeholder="748514" required
                   value="${editionForm.stockNumber}">
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="writings" id="writings" multiple>
                <#list writings as writing>
                    <option value="${writing.id}" name="${writing.name}">${writing.name}</option>
                </#list>
            </select>
        </div>
