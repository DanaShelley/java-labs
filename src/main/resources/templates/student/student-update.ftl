    ...
    <form name="studentForm" action="" method="POST" class="row g-3">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="membership" id="membership" required>
                <option value="${student.membership.id}" name="${student.membership.id}"
                        selected>${student.membership.name}</option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="university" id="university" class="form-control"
                   placeholder="ЧНУ ім.Юрія Федьковича" required value="${student.university}">
        </div>

        <div class="form-group">
            <label for="faculty" class="form-label">Faculty: </label>
            <input type="text" name="faculty" id="faculty" class="form-control" placeholder="Факультет іноземних мов"
                   required value="${student.faculty}">
        </div>

        <div class="form-group">
            <label for="studentId" class="form-label">StudentID: </label>
            <input type="text" name="studentId" id="studentId" class="form-control" placeholder="45dfs15"
