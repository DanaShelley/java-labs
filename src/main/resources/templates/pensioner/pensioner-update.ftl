    ...
    <form name="pensionerForm" action="" method="POST" class="row g-3">
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="membership" id="membership" required>
                <option value="${pensioner.membership.id}" name="${pensioner.membership.id}"
                        selected>${pensioner.membership.name}</option>
            </select>
        </div>
        ...
        <div class="form-group">
            <label for="pensionerId" class="form-label">PensionerID: </label>
