...
<div style="width: 500px; margin: 0 auto">
    ...
    <form name="staffForm" action="" method="POST" class="row g-3">
        ...
        <div class="form-group">
            ...
            <input type="text" name="phone" id="phone" class="form-control" placeholder="+380966308974">
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" name="position" id="position">
                <#list positions as position>
                    <option value="${position.id}" name="${position.position}">${position.position}</option>
                </#list>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="employmentDate" id="employmentDate" class="form-control"
                   value="${staffForm.employmentDate}" required>
        </div>
